...
class HocBongPage extends StatefulWidget {
  const HocBongPage({Key? key}) : super(key: key);

  @override
  State<HocBongPage> createState() => _HocBongPageState();
}
...
class _HocBongPageState extends State<HocBongPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: _menu,
      appBar: AppBar(centerTitle: true, title: Text('Học bổng - vay vốn - học phí'), actions: [
        TextButton(
            onPressed: () {
